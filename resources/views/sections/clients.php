<div class="row justify-content-center section_clients" >       
    <div class="col-md-4 col-xs-10 col-sm-10 element-zoom-in align-self-center">
        <img class="img-fluid" src="<?=$routes["img_content_clientes"]?>" alt=" <?= $vocab["clientes_titulo"] ?>">
    </div>  
    <div class="col-md-1"></div>
    <div class="col-md-4 col-xs-10 col-sm-10 align-self-center">
        ...
        <div id="myCarousel" class="carousel slide w-100" data-ride="carousel">
            <div class="carousel-inner w-100" role="listbox">
                <div class="carousel-item active">
                    ...
                    <img style = "width:100%" data-src="<?= $routes["img_content_cliente_1"]?>" class="img-fluid lazyload "  alt = "Clientes de Qwerty">
                   
                    </div>
                </div>
                <div class="carousel-item">
                    <div class="col-lg-4 col-md-6">
                    <img  style = "width:100%" data-src="<?= $routes["img_content_cliente_2"]?>" class="img-fluid lazyload "  alt = "Clientes de Qwerty">
                   
                    </div>
                </div>
                <div class="carousel-item">
                    <div class="col-lg-4 col-md-6">
                        <img style = "width:100%" data-src="<?= $routes["img_content_cliente_3"]?>" class="img-fluid lazyload "  alt = "Clientes de Qwerty">
                    </div>
                </div>
                <div class="carousel-item">
                    <div class="col-lg-4 col-md-6">
