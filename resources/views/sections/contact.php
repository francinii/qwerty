<div class="row section_description">
    ...
    <div class="col-md-5 col-xs-10 col-sm-10  mx-auto ">     
       ...
       <form class="form-horizontal" action="">
              ...
              <div class="form-group">
                <label class="control-label col-sm-2" for="mail"><?= $vocab["contacto_form_correo"] ?></label>
                <div class="col-sm-10">
                  <input type="email" class="form-control" id="mail" placeholder="Dirección de correo">
                </div>
              </div>
              <div class="form-group">
                <label class="control-label col-sm-2" for="message"><?= $vocab["contacto_form_mensaje"] ?></label>
                <div class="col-sm-10">
