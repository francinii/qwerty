<nav class=" header sticky-top  navbar navbar-expand-md navbar-dark"> 
  ...
  <div class="collapse navbar-collapse" id = "main_nav" >       
    <ul class="nav navbar-nav ml-auto align-items-center">         
        ...
        <li class="nav-item dropdown">
            ...
            <img src="<?=$routes["img_content_lang"]?>" alt="Language">
            </a>
            <div class="dropdown-menu dropdown-menu-right ">
              <a class=" nav-item dropdown-item " name = 'es' onclick = 'language("es")' >Español</a>
              <a class=" nav-item dropdown-item " name = 'en' onclick = 'language("en")'  >English</a>            
            </div>
        </li>
      </ul> 
  </div>   
